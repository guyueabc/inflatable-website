"""
InflatableModel.CN — Flask backend
...
# ── Proxy routing: when HUNYUAN_PROXY_URL is set, route through HK proxy ──
...
def _extract_api_error(data: dict) -> str:
    ...
    # Tencent Cloud：Response.Error.Message
